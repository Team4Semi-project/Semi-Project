package kr.co.lemona.common.config;
...
public class FileConfig implements WebMvcConfigurer{
	...
	// WebMvcConfigurer : Spring MVC 프레임워크에서 제공하는 인터헤이스 중 하나로,
	...
	// 레시피 이미지 관련 경로
	@Value("${my.recipeBoard.resource-handler}")
	private String recipeBoardResourceHandler;

	@Value("${my.recipeBoard.resource-location}")
	private String recipeBoardResourceLocation;
...
//		.addResourceLocations("file:///C:/uploadFiles/test/");
		...
		// 서버폴더 경로 중 C:/uploadFiles/test/ 로 연결하겠다
		...
		registry
		.addResourceHandler(recipeBoardResourceHandler)		// /images/recipeBoard/**
		.addResourceLocations(recipeBoardResourceLocation); // file:///C:/uploadFiles/recipeBoard/
	}
	...
	public MultipartConfigElement configElement() {
		...
		// 업로드 파일의 최대 크기, 메모리에서의 임시 자정경로 등 설정 가능
