...
public class RecipeBoardController {
	...
	public String insertRecipeBoard(RecipeBoard inputBoard,
			...
			@RequestParam("stepContents") List<String> inputStepContent, @RequestParam("thumbnailNo") int thumbnailNo,
			@RequestParam("hashTags") List<String> hashTagList, RedirectAttributes ra) throws Exception {
