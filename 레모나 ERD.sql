...
--DROP SEQUENCE SEQ_BOARD_STEP_NO;
--DROP SEQUENCE SEQ_DEFAULT_COMMENT_NO;
--DROP SEQUENCE SEQ_MEMBER_NO;
--DROP SEQUENCE SEQ_RECIPE_B_NO;
--DROP SEQUENCE SEQ_RECIPE_COMMENT_NO;
--DROP SEQUENCE SEQ_RECIPE_LIKE_NO;
--DROP SEQUENCE SEQ_REC_COMMENT_NO;
--DROP SEQUENCE SEQ_TAG_NO;
--
--DROP SEQUENCE SEQ_KEY_NO;
--DROP SEQUENCE SEQ_RECIPE_BOARD_NO;
--
...
-- 레시피 댓글 번호 시퀀스 만들기
CREATE SEQUENCE SEQ_RECIPE_COMMENT_NO NOCACHE;

INSERT INTO "RECIPE_COMMENT" VALUES (SEQ_RECIPE_COMMENT_NO.NEXTVAL, '맛있겠어요!', SYSDATE, 'N', 1, NULL, 1);
INSERT INTO "RECIPE_COMMENT" VALUES (SEQ_RECIPE_COMMENT_NO.NEXTVAL, '한번 해볼게요.', SYSDATE, 'N', 2, NULL, 2);
INSERT INTO "RECIPE_COMMENT" VALUES (SEQ_RECIPE_COMMENT_NO.NEXTVAL, '굿레시피입니다.', SYSDATE, 'N', 3, NULL, 3);
...
CREATE SEQUENCE SEQ_DEFAULT_COMMENT_NO NOCACHE;

INSERT INTO "DEFAULT_COMMENT" VALUES (SEQ_DEFAULT_COMMENT_NO.NEXTVAL, '댓글1입니다.', SYSDATE, 'N', 1, NULL, 1);
INSERT INTO "DEFAULT_COMMENT" VALUES (SEQ_DEFAULT_COMMENT_NO.NEXTVAL, '댓글2입니다.', SYSDATE, 'N', 2, NULL, 2);
INSERT INTO "DEFAULT_COMMENT" VALUES (SEQ_DEFAULT_COMMENT_NO.NEXTVAL, '댓글3입니다.', SYSDATE, 'N', 3, NULL, 3);
...
COMMENT ON COLUMN "BOARD_HASHTAG"."BOARD_NO" IS '게시글 번호(FK)';
...
COMMENT ON COLUMN "DEFAULT_BOARD_LIKE"."BOARD_NO" IS '게시글 번호(FK)';
...
COMMENT ON COLUMN "RECIPE_BOARD_LIKE"."BOARD_NO" IS '게시글 번호(FK)';
...
COMMENT ON COLUMN "BOARD_STEP"."STEP_NO" IS '단계번호(FK)';
...
-- 레시피 게시글 번호 시퀀스 만들기
CREATE SEQUENCE SEQ_RECIPE_BOARD_NO NOCACHE;

INSERT INTO "RECIPE_BOARD" VALUES (SEQ_RECIPE_BOARD_NO.NEXTVAL, '김치찌개', 0, 'N', SYSDATE, NULL, 1, 2, 1);
INSERT INTO "RECIPE_BOARD" VALUES (SEQ_RECIPE_BOARD_NO.NEXTVAL, '파스타', 0, 'N', SYSDATE, NULL, 2, 2, 2);
INSERT INTO "RECIPE_BOARD" VALUES (SEQ_RECIPE_BOARD_NO.NEXTVAL, '짜장면', 0, 'N', SYSDATE, NULL, 3, 2, 3);
...
ALTER TABLE "RECIPE_COMMENT" ADD CONSTRAINT "FK_MEMBER_TO_RECIPE_COMMENT_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"MEMBER_NO"
...
ALTER TABLE "RECIPE_COMMENT" ADD CONSTRAINT "FK_RECIPE_COMMENT_TO_RECIPE_COMMENT_1" FOREIGN KEY (
	"PARENT_COMMENT_NO"
)
...
ALTER TABLE "RECIPE_COMMENT" ADD CONSTRAINT "FK_RECIPE_BOARD_TO_RECIPE_COMMENT_1" FOREIGN KEY (
	"BOARD_NO"
)
...
ALTER TABLE "DEFAULT_COMMENT" ADD CONSTRAINT "FK_MEMBER_TO_DEFAULT_COMMENT_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"MEMBER_NO"
...
ALTER TABLE "DEFAULT_COMMENT" ADD CONSTRAINT "FK_DEFAULT_COMMENT_TO_DEFAULT_COMMENT_1" FOREIGN KEY (
	"PARENT_COMMENT_NO"
)
...
ALTER TABLE "DEFAULT_COMMENT" ADD CONSTRAINT "FK_BOARD_TO_DEFAULT_COMMENT_1" FOREIGN KEY (
	"BOARD_NO"
)
REFERENCES "BOARD" (
	"BOARD_NO"
...
ALTER TABLE "BOARD_STEP" ADD CONSTRAINT "FK_RECIPE_BOARD_TO_BOARD_STEP_1" FOREIGN KEY (
	"BOARD_NO"
)
REFERENCES "RECIPE_BOARD" (
	"BOARD_NO"
...
ALTER TABLE "RECIPE_BOARD" ADD CONSTRAINT "FK_MEMBER_TO_RECIPE_BOARD_1" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"MEMBER_NO"
...
ALTER TABLE "RECIPE_BOARD" ADD CONSTRAINT "FK_BOARD_TYPE_TO_RECIPE_BOARD_1" FOREIGN KEY (
	"BOARD_CODE"
)
REFERENCES "BOARD_TYPE" (
	"BOARD_CODE"
...
ALTER TABLE "RECIPE_BOARD" ADD CONSTRAINT "FK_CATEGORY_TO_RECIPE_BOARD_1" FOREIGN KEY (
	"CATEGORY_NO"
)
REFERENCES "CATEGORY" (
	"CATEGORY_NO"
