...
-- UNIQUE 및 DELETE CASCADE 제약조건 추가 코드
...
-- 2. 기존 FK 삭제 (ON DELETE CASCADE 설정 위해 필요)
-- DEFAULT_COMMENT 테이블
ALTER TABLE "DEFAULT_COMMENT" DROP CONSTRAINT "SYS_C_FK_DEFAULT_COMMENT_MEMBER"; -- 기존 이름은 다를 수 있음
-- RECIPE_COMMENT 테이블
ALTER TABLE "RECIPE_COMMENT" DROP CONSTRAINT "SYS_C_FK_RECIPE_COMMENT_MEMBER";
-- BOARD 테이블
ALTER TABLE "BOARD" DROP CONSTRAINT "SYS_C_FK_BOARD_MEMBER";
-- RECIPE_BOARD 테이블
ALTER TABLE "RECIPE_BOARD" DROP CONSTRAINT "SYS_C_FK_RECIPE_BOARD_MEMBER";
-- DEFAULT_BOARD_LIKE 테이블
ALTER TABLE "DEFAULT_BOARD_LIKE" DROP CONSTRAINT "SYS_C_FK_DEFAULT_BOARD_LIKE_MEMBER";
-- RECIPE_BOARD_LIKE 테이블
ALTER TABLE "RECIPE_BOARD_LIKE" DROP CONSTRAINT "SYS_C_FK_RECIPE_BOARD_LIKE_MEMBER";
-- DEFAULT_COMMENT_LIKE 테이블
ALTER TABLE "DEFAULT_COMMENT_LIKE" DROP CONSTRAINT "SYS_C_FK_DEFAULT_COMMENT_LIKE_MEMBER";
-- RECIPE_COMMENT_LIKE 테이블
ALTER TABLE "RECIPE_COMMENT_LIKE" DROP CONSTRAINT "SYS_C_FK_RECIPE_COMMENT_LIKE_MEMBER";

-- 3. ON DELETE CASCADE 옵션이 포함된 FK 재생성
...
-- 1. BOARD → DEFAULT_COMMENT
ALTER TABLE "DEFAULT_COMMENT"
DROP CONSTRAINT "SYS_C_FK_DEFAULT_COMMENT_BOARD"; -- 실제 이름은 조회 필요
ALTER TABLE "DEFAULT_COMMENT"
ADD CONSTRAINT "FK_DEFAULT_COMMENT_BOARD"
FOREIGN KEY ("BOARD_NO") REFERENCES "BOARD"("BOARD_NO") ON DELETE CASCADE;

-- 2. BOARD → DEFAULT_BOARD_LIKE
ALTER TABLE "DEFAULT_BOARD_LIKE"
DROP CONSTRAINT "SYS_C_FK_DEFAULT_BOARD_LIKE_BOARD";
ALTER TABLE "DEFAULT_BOARD_LIKE"
ADD CONSTRAINT "FK_DEFAULT_BOARD_LIKE_BOARD"
FOREIGN KEY ("BOARD_NO") REFERENCES "BOARD"("BOARD_NO") ON DELETE CASCADE;

-- 3. BOARD → DEFAULT_COMMENT_LIKE
ALTER TABLE "DEFAULT_COMMENT_LIKE"
DROP CONSTRAINT "SYS_C_FK_DEFAULT_COMMENT_LIKE_BOARD";
ALTER TABLE "DEFAULT_COMMENT_LIKE"
ADD CONSTRAINT "FK_DEFAULT_COMMENT_LIKE_BOARD"
FOREIGN KEY ("BOARD_NO") REFERENCES "BOARD"("BOARD_NO") ON DELETE CASCADE;

-- 4. DEFAULT_COMMENT → DEFAULT_COMMENT_LIKE
ALTER TABLE "DEFAULT_COMMENT_LIKE"
DROP CONSTRAINT "SYS_C_FK_DEFAULT_COMMENT_LIKE_COMMENT";
ALTER TABLE "DEFAULT_COMMENT_LIKE"
...
-- 5. RECIPE_BOARD → RECIPE_COMMENT
ALTER TABLE "RECIPE_COMMENT"
DROP CONSTRAINT "SYS_C_FK_RECIPE_COMMENT_BOARD";
ALTER TABLE "RECIPE_COMMENT"
ADD CONSTRAINT "FK_RECIPE_COMMENT_BOARD"
FOREIGN KEY ("BOARD_NO") REFERENCES "RECIPE_BOARD"("BOARD_NO") ON DELETE CASCADE;

-- 6. RECIPE_BOARD → RECIPE_BOARD_LIKE
ALTER TABLE "RECIPE_BOARD_LIKE"
DROP CONSTRAINT "SYS_C_FK_RECIPE_BOARD_LIKE_BOARD";
ALTER TABLE "RECIPE_BOARD_LIKE"
ADD CONSTRAINT "FK_RECIPE_BOARD_LIKE_BOARD"
FOREIGN KEY ("BOARD_NO") REFERENCES "RECIPE_BOARD"("BOARD_NO") ON DELETE CASCADE;

-- 7. RECIPE_BOARD → RECIPE_COMMENT_LIKE
ALTER TABLE "RECIPE_COMMENT_LIKE"
DROP CONSTRAINT "SYS_C_FK_RECIPE_COMMENT_LIKE_BOARD";
ALTER TABLE "RECIPE_COMMENT_LIKE"
ADD CONSTRAINT "FK_RECIPE_COMMENT_LIKE_BOARD"
FOREIGN KEY ("BOARD_NO") REFERENCES "RECIPE_BOARD"("BOARD_NO") ON DELETE CASCADE;

-- 8. RECIPE_COMMENT → RECIPE_COMMENT_LIKE
ALTER TABLE "RECIPE_COMMENT_LIKE"
DROP CONSTRAINT "SYS_C_FK_RECIPE_COMMENT_LIKE_COMMENT";
ALTER TABLE "RECIPE_COMMENT_LIKE"
